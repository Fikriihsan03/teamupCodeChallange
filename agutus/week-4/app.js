...
pesan = `perbandigan antara x2 yang bernilai ${x2} dan x4 yang bernilai ${x4} adalah ${x2==x4}`
if(x2 == x4){
    console.log(pesan)
}
...
if(x1 > 10){
    ...
    console.log("belum true");
}else if(x3 > 10){
    console.log("tetap false");
}else if(x4 > 10){
    console.log("belum jalan");
}else if(x5 > 10){
    console.log("ga jalan-jalan");
}else if(x6 > 10){
...
if(x1 < 1){
    ...
    console.log("sepertinya tidak ada variabel yang nilainya lebih kecil dari satu");
}else{
    console.log("tidak ada nilai variabel yang lebih kecil dari 1")
}